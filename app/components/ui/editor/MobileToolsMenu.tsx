        ...
        <Dialog.Content className="fixed bottom-0 left-0 right-0 bg-[#1a1a1d] border-t border-white/10 rounded-t-2xl z-101 p-6 animate-in slide-in-from-bottom duration-300 max-h-[80vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <ToolButton
              ...
              icon={
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className={activeTool === "elements" ? "text-white" : "text-white/70"}>
            ...
            <label
              className={`flex items-center justify-center p-4 squircle-element transition-all duration-200 group relative flex-col gap-1 active:scale-95 cursor-pointer ${
